...
export default async function BlogPostPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-6">
        <Link href="/blog" className="text-green-600 hover:text-green-800 flex items-center gap-2 transition-colors">
      ...
      <div className="mt-12 pt-8 border-t border-gray-200">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
          ...
          <Link href="/blog" className="bg-green-600 hover:bg-green-700 text-white py-2 px-6 rounded-lg transition-colors">
            Read more articles
          </Link>
        </div>
      </div>
